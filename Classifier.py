    ...
    def __init__(self,elcs,a=None,b=None,c=None,d=None):
                ...
                for attRef in comboAttList:
                    ...
                    if ref == 0:
                        ...
                        if attRef in p_self_specifiedAttList and random.random() > probability:
                            ...
                            self.conditionContinuous = np.delete(self.conditionContinuous,i)
                        ...
                        if attRef in p_cl_specifiedAttList and random.random() < probability:
                            ...
                            cl.conditionContinuous = np.delete(cl.conditionContinuous, i)
                        ...
                        if attributeInfoType:
                            ...
                            if tempKey == 0:
                                ...
                                if tempKey == 2:
                                    ...
                                    cl.conditionContinuous = np.delete(cl.conditionContinuous,i_cl2)
                                    ...
                                    self.conditionContinuous = np.delete(cl.conditionContinuous, i_cl1)
        ...
        def Mutation(self, elcs, state, phenotype):
            ...
            for attRef in range(elcs.env.formatData.numAttributes):
                ...
                if random.random() < elcs.upsilon and not(np.isnan(state[attRef].value)):
                    # Mutation
