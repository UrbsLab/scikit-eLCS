...
clf.exportRulePopulationAtIterationToCSV(4999,headerNames=headers,className=classLabel,ALKR=True)
clf.exportPopStatsToCSV(99,headerNames=headers)
clf.exportFinalPopStatsToCSV(headerNames=headers,filename="finalPopStats.csv")
